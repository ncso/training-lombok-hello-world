 ...
 * are directed to a slf4j logger for "com.acme.log".   Otherwise the logs
 * are directed to stderr.
 * <p>
 * The "com.acme.log.class" system property can be used
 * to select a specific logging implementation.
 * <p>
 * If the system property com.acme.log.IGNORED is set,
    ...
    static
    {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
                ...
                URL testProps = Loader.getResource(Log.class,"acme-logging.properties");
                if (testProps != null)
                {
                    InputStream in = null;
                    try
                 ...
                 */
                __logClass = __props.getProperty("com.acme.log.class","com.acme.log.Slf4jLog");
                __ignored = Boolean.parseBoolean(__props.getProperty("com.acme.log.IGNORED","false"));
                return null;
            }
        });
    }
