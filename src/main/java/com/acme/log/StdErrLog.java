 ...
 *   Examples:
 *   <dl>
 *   <dt>com.acme.LEVEL=WARN</dt>
 *   <dd>indicates that all of the jetty specific classes, in any package that 
 *   starts with <code>com.acme</code> should log at level WARN.</dd>
 *   <dt>com.acme.io.ChannelEndPoint.LEVEL=ALL</dt>
 ...
 *   Default: false
 *   </dd>
 *   <dt>com.acme.log.stderr.ESCAPE=(true|false)</dt>
...
public class StdErrLog extends AbstractLogger
{
    ...
    private final static boolean __source = Boolean.parseBoolean(Log.__props.getProperty("com.acme.log.SOURCE",
            Log.__props.getProperty("com.acme.log.stderr.SOURCE","false")));
    private final static boolean __long = Boolean.parseBoolean(Log.__props.getProperty("com.acme.log.stderr.LONG","false"));
    private final static boolean __escape = Boolean.parseBoolean(Log.__props.getProperty("com.acme.log.stderr.ESCAPE","true"));
     ...
     * <pre>
     * Examples:
     * "com.acme.test.FooTest"           = "oejt.FooTest"
     * "com.acme.server.logging.LogTest" = "orjsl.LogTest"
     * </pre>
     *
     * @param classname
    ...
    private void tag(StringBuilder buffer, String d, int ms, String tag)
    {
        ...
        if (_source)
        {
            ...
            for (int i = 0; i < frames.length; i++)
            {
                ...
                if (!_printLongNames && clazz.startsWith("com.acme."))
                {
